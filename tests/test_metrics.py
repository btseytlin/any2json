...
class TestCalculateDiffMetrics:
    def test_identical_dicts(self):
        ...
        assert round(result["levenstein_distance"], 4) == 1.0
    ...
    def test_added_field(self):
        ...
        assert result["diff_size_chars_missing"] == 0
        assert round(result["levenstein_distance"], 4) == 0.8125
    ...
    def test_removed_field(self):
        ...
        assert round(result["levenstein_distance"], 4) == 0.7
    ...
    def test_modified_value(self):
        ...
        assert round(result["levenstein_distance"], 4) == 0.9231
    ...
    def test_nested_structure_modified_value(self):
        ...
        assert result["diff_size_chars_added"] == 1
        assert result["diff_size_chars_missing"] == 1
        assert round(result["levenstein_distance"], 4) == 0.9444
    ...
    def test_list_difference(self):
        ...
        assert result["diff_size_chars_missing"] == 0
        assert round(result["levenstein_distance"], 4) == 0.9375

...
class TestSupportedSchema:
    ...
    def test_refs_complex(self):
        schema = {
            "$id": "https://example.com/alexander-the-great",
            "type": "array",
            "items": {"$ref": "#/definitions/Event"},
            "definitions": {
                "Event": {
                    "$id": "https://example.com/event-definition",
                    "type": "object",
                    "properties": {
                        "event_name": {"$ref": "#/definitions/String"},
                        "date": {"type": "string"},
                        "location": {"$ref": "#/definitions/Location"},
                        "conquest_type": {"$ref": "#/definitions/String"},
                    },
                    "required": ["event_name", "date", "location"],
                    "additionalProperties": False,
                },
                "String": {
                    "$id": "https://example.com/string-definition",
                    "type": "string",
                },
                "Location": {
                    "$id": "https://example.com/location-definition",
                    "type": "object",
                    "properties": {
                        "region": {"$ref": "#/definitions/String"},
